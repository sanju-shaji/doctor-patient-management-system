...
public class ApplicationConstants {
    ...
    public static final String DEPARTMENT_NAME_PATTERN_ERROR = "Department Name should not contain any special symbols or numbers";
    public static final String DOCTORS_NOT_FOUND = "No Doctors found";
    public static final String EMPTY_DEPARTMENT_NAME = "Department name should not be an empty or null";
